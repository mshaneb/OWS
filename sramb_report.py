...
def main():
    ...
    path_list = [os.path.normpath("S:\SRAMB")
                 ]

    write_mode = ["w+"  # add "a" to list if addl paths added
                  ]
    ...
    reportname = (reportdir + "SRAMB_Report_" + reporttimestamp + ".csv")
